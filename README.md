...
```scala
libraryDependencies += "com.github.xuwei-k" %% "msgpack4z-native" % "0.3.1"
```

- [sxr](https://oss.sonatype.org/service/local/repositories/releases/archive/com/github/xuwei-k/msgpack4z-native_2.11/0.3.1/msgpack4z-native_2.11-0.3.1-sxr.jar/!/index.html)
